...
import { CartContext } from "./context/CartContext"; // 🔥 to‘g‘rilandi
    ...
    <header className="fixed top-0 w-full z-50">
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-5 h-[44px] flex items-center justify-between text-[14px] text-gray-600">
          <div className="flex items-center gap-6">
            ...
            <button className="hover:text-orange-500">{t.check_address}</button>
            <span>
              {t.delivery_time}: <b className="ml-1 text-black">00:24:19</b>
            </span>
          </div>
          <div className="flex items-center gap-6">
            <span>{t.work_time}: 11:00–23:00</span>
            <button className="hover:text-orange-500">{t.login}</button>
            <select
              value={lang}
      ...
      <div className="bg-white">
        <div className="container mx-auto px-5 h-16 flex items-center justify-between">
          <Link
            to="/"
            className="flex items-center gap-2 text-orange-500 font-bold text-[20px]"
          >
            🍕 Куда пицца
          </Link>
